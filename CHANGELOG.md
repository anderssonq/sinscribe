...
- e414997: 📝 Compact the documentation and harden the private-files boundary.
...
- 74ef93b: 📝 docs: rewrite the documentation against the code
...
- 175f7fe: ✨ feat(ui): richer loading indicator — pixel-grid wavefront, shimmering label, tenths timer
...
- 6a7d6f6: Centre the UI on wide terminals, and add "Set up project agents".
